...
<button onclick="toggleTranslateDropdown()" style="background-color: #e0f9e0; color: #1b5e20; padding: 10px; border: none; cursor: pointer; display: flex; align-items: center; gap: 5px;">
